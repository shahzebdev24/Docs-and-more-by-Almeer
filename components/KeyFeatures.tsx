...
export default function KeyFeatures() {
    return (
        <section id="key-features" className="py-16 md:py-32 bg-transparent relative overflow-hidden">
                    ...
                    <div className="lg:col-span-12 xl:col-span-7">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-7xl font-black text-[#006A70] mb-8 tracking-tighter leading-none uppercase">
                                Elite <span className="text-[#B87333]">Infrastructure</span>
                            </h2>
                                ...
                                {features.map((feature, i) => (
                                    ...
                                    >
                                        <div className="flex gap-6">
                                            ...
                                            <div>
                                                <h3 className="text-xl font-black text-[#006A70] mb-3 uppercase tracking-tighter group-hover:text-[#B87333] transition-colors">
                                                    {feature.title}
                                                </h3>
                    ...
                    >
                        <div className="relative rounded-[50px] overflow-hidden shadow-2xl border-[20px] border-white group">
                            <Image
                                ...
                                width={800}
                                height={1000}
                                className="w-full h-[350px] md:h-[650px] object-cover grayscale group-hover:grayscale-0 transition-all duration-1000"
                            />
